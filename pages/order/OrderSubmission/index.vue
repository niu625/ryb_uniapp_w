  ...
  <view class="order-submission">
    <view class="allAddress" :style="systemStore ? '' : 'padding-top: 0.2*100rpx'">
      <view class="nav acea-row">
        ...
        <view class="item font-color-red" :class="shipping_type === 1 ? 'on' : 'on2'" @click="addressType(1)" v-if="systemStore && !isIntegral && false"></view>
      </view>
    ...
    <view class="wrapper">
      ...
      <view class="item acea-row row-between-wrapper" v-if="!isIntegral && deduction === false && enableIntegral === true && false">
        <view>积分抵扣</view>
        <view class="discount">
    ...
    <view class="wrapper">
      <view class="item">
        ...
        <view class="list">
          ...
          <view class="payItem acea-row row-middle" v-if="!isIntegral && false" :class="active === 'yue' ? 'on' : ''" @click="payItem('yue')">
